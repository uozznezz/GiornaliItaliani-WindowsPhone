...
using GiornaliItaliani.Resources;

namespace GiornaliItaliani
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void loadFeedButton1_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            webClient.DownloadStringAsync(new System.Uri("http://www.ilsole24ore.com/rss/primapagina.xml"));
        }
        ...
        private void loadFeedButton2_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            // Download the RSS feed. DownloadStringAsync was used instead of OpenStreamAsync because we do not need 
            // to leave a stream open, and we will not need to worry about closing the channel. 
            webClient.DownloadStringAsync(new System.Uri("http://www.repubblica.it/rss/homepage/rss2.0.xml"));
        }
